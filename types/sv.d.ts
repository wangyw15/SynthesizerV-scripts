declare module SV {
    ...
    const showCustomDialog: (form: object) => DialogResult;
    ...
    class ArrangementSelectionState extends NestedObject {}
    ...
    class TrackInnerSelectionState extends NestedObject {
        clearNotes: () => boolean;
    ...
    class DialogResult extends NestedObject {
        answers: any;
        status: number;
    }
